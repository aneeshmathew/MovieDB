...
export function MovieDetailPage() {
  ...
  return (
    <div>
      ...
      <div className="mx-auto -mt-24 flex max-w-5xl flex-col gap-6 px-4 sm:flex-row sm:px-8">
        {poster && (
          <img
            src={poster}
            alt={`${movie.title} poster`}
            className="w-40 shrink-0 rounded-md ring-1 ring-line sm:w-56"
          />
        )}
          ...
          {isLoggedIn && (
            <div className="mt-4 flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 rounded-full border border-line px-3 py-1.5 font-mono text-xs uppercase text-ink hover:border-amber"
              >
                <Bookmark
